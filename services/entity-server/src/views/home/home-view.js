...
const HomeViewText = () => (
  <>
    ...
    <p>
      Innovonto is a research project investigating how to analyze, understand
      and augment idea generation processes with the help of algorithmic
      systems. We especially focus on these three topics in the context of
      large-scale ideation.
    </p>
    <p>
      Within our research, we developed prototypes for various ideation support
      tools and furthermore conducted idea generation challenges for different
    ...
    <p>
      Wikipedia defines Ideation as "the creative process of generating,
      developing, and communicating new ideas, where an idea is understood as a
      basic element of thought that can be either visual, concrete, or
      abstract."
      <a
        href="https://en.wikipedia.org/wiki/Ideation_(creative_process)"
        target="_blank"
    ...
    <p>
      So far this is a pretty broad topic, ranging from{" "}
      <a
        href="https://dash.harvard.edu/bitstream/handle/1/30859746/siangliulue16ideahound-uist.pdf?sequence=1"
        target="_blank"
        rel="noopener noreferrer"
      >
        generating a text for a birthday card
      </a>{" "}
      to{" "}
      <a href="https://openideo.com/" target="_blank" rel="noopener noreferrer">
        tackling "the world's biggest challenges"
      </a>
      . In order to get a context that enables to formulate actual research
      questions, we have to further limit the scope:
    </p>
    <p>
      The requirements for the processes of <em>generating</em>,{" "}
      <em>developing</em> and <em>communicating</em> ideas are very different.
      So we start by limiting ourselves to the process of <em>generating</em>{" "}
      new ideas, which means the process of actually getting ideas out of your
      head and, in our context, into some form of digital data.
    </p>
    <p>
      One of the challenges to define "ideation" in a useful way, is that ideas
      can look vastly different in terms of data, depending on their field. For
      example, ideas for a new type of car could be in the form of images or 3d
      models, while ideas for a theme song of a tv-series could be in the form
      of audio files or sheet music. So our first compromise is to limit our
      scope to one very general mode of an idea: <strong>text</strong>.
    </p>

    <h3>What is Large-Scale Ideation?</h3>
    <p>
      Over the last decade <em>crowdsourcing</em> has been identified as a novel
      and promising approach for a variety of tasks. Crowdsourcing describes a
      way to execute tasks by handing them over to a large group of people (the
      crowd) via the internet. One specific application of crowdsourcing is the
      collection of large numbers ideas for a given problem, topic or challenge.
    </p>
    <p>
      This approach has great potential: By bringing hundreds of people from
      diverse backgrounds and context together, crowd-sourcing enables the
      collection of large numbers of ideas on complex problems, increasing the
      potential for creative and potentially groundbreaking out of the box
      contributions. Crowd-sourced ideation led to new developments both in
      industry and in research. In industry, it gave rise to large scale
      ideation platforms, for example{" "}
      <a
        href="https://www.innocentive.com/"
        target="_blank"
        rel="noopener noreferrer"
      >
        InnoCentive
      ...
      ,{" "}
      <a href="https://quirky.com/" target="_blank" rel="noopener noreferrer">
        Quirky
      </a>{" "}
      or{" "}
      <a
        href="https://www.openideo.com/"
        target="_blank"
        rel="noopener noreferrer"
      >
        OpenIDEO
      </a>
      . In research, it helped establish the fields of
      <em>Open Innovation</em> in the context of economics as well as{" "}
      <em>large scale collaborative ideation</em> in HCI.
    </p>
    <p>
      The large-scale ideation research in HCI especially focusses on the
    ...
    <ul>
      ...
      <li>
        ...
        multiple times. In group settings, people are aware of all others' ideas
