...
const IdeaModelingText = () => (
  <>
    ...
    <p>
      ...
      snippets. <a href={"/entities/ideas/cf65b021-620f-43fe-9473-1712be788cde"}>Show me an example</a> Furthermore, by defining ideas as
      ...
      model on the <a href={"http://www.gi2mo.org/ontology/"} target="_blank" rel="noopener noreferrer">Generic Idea and Innovation Management
...
const IdeaLifecycleText = () => (
  <p>
    The second aspects of ideas is that they are living things. Compared to data that lies in tables, an idea can evolve,
    be further developed, or archived. Furthermore ideas can be split, merged or branched. Ideation is a process, and this
    process is at least as important then the idea itself. To capture this process, we need to visualize relationships between
    ideas (both ideas with similar content, or ideas created in the same brainstorming session), and their state of development.
    Our vision is to have a "github of ideas" system, that enables everybody to iterate, refine or be inspired by each others ideas and
...
const IdeaSpaceVisualizationText = () => (
  <p>
    ...
    <em>Idea Space</em>: A conceptual space of all ideas captured for a challenge together with a spatial relation between
